  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-info">Edit Data Kendaraan</h6>
      </div>
      <div class="card-body">
        <form method="post" action="<?php echo base_url(); ?>index.php/ga/Vehicles/update" >       

        <input type="hidden" name="id" value="<?= $id ?>">  
        <div class="form-group row">
            <label for="vehicle_code" class="col-sm-2 col-form-label">Kode Kendaraan : </label>
            <div class="col-sm-10">
              <input type="text" name="vehicle_code" class="form-control" id="vehicle_code" placeholder="" required autofocus value="<?= $vehicle_code ?>">
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" name="plate_number" class="form-control" id="plate_number" placeholder="" required autofocus value="<?= $plate_number ?>">
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" name="vehicle_name" class="form-control" id="vehicle_name" placeholder="" required autofocus value="<?= $vehicle_name ?>">
            </div>
