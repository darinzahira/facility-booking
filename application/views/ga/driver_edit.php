<!-- Begin Page Content -->
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <form method="post" action="<?php echo base_url(); ?>index.php/ga/Drivers/store" >
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" name="driver_code" class="form-control" id="driver_code" placeholder="" required autofocus value="<?php echo set_value('driver_code');?>">
            </div>
